							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="example-text-input" class="form-control-label">Código de barras<span class="text-danger"> *</span></label>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleFormControlSelect1">Categoría<span class="text-danger"> *</span></label>
										<div>
											<button class="btn btn-icon btn-3 bg-gradient-default mb-0" type="button" data-bs-toggle="dropdown">
								...
								<div class="col-md-12">
									<div class="form-group">
										<label for="example-text-input" class="form-control-label">Nombre<span class="text-danger"> *</span></label>
								...
								<div class="col-md-12">
									<div class="button-row d-flex mt-4">
										<button class="btn bg-gradient-success ms-auto mb-0" @click.prevent="saveProduct">Guardar</button>
									</div>
								</div>
							</div>
						</div>
