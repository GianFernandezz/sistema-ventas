						...
						<div class="d-flex">
							<div class="picture ms-auto me-auto">
								...
								<label for="profileFile">
									<img :src="preview" class="rounded-circle img-fluid border border-4 border-white" rel="tooltip" title="Cambiar foto de perfil">
								</label>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="button-row d-flex mt-4 mb-2">
										<a class="btn bg-gradient-primary ms-auto mb-0 me-1" href="<?= base_url('dashboard');?>">Cancelar</a>
										<button class="btn bg-gradient-success mb-0" type="submit">Guardar</button>
									</div>
								</div>
							</div>
						</form>
