					...
					<div class="card-header pb-0">
						<div class="d-md-flex">
							...
							<div class="ms-auto my-auto mt-lg-0 mt-4">								
								<a href="<?= base_url('reports/reportall/downloadExcelCategory'); ?>" class="btn bg-gradient-default me-4" data-toggle="tooltip" data-placement="top" title="Reporte Excel">
									<img src="<?= base_url('assets/img/excel.png'); ?>" alt="Download-Excel">
								</a>	
								<a href="<?= base_url('reports/reportall/rptCategory'); ?>" class="btn bg-gradient-default" data-toggle="tooltip" data-placement="top" title="Reporte PDF" target="_blank">
									...
									<tr v-for="(item, index) in rows()">
										...
										<td>
											<div class="ms-auto text-lg d-flex px-2">
												<div><a class="btn btn-link px-3 mb-0 bg-gradient-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#modalEdit" @click="readCategory(index)"><i class="fa-solid fa-pen-to-square me-2"></i>Edit</a></div>
												<div><a class="btn btn-link px-3 mb-0 bg-gradient-danger btn-sm" @click="deleteCategory(item.id)"><i class="fa fa-trash me-2"></i>Delete</a></div>
											</div>
										</td>
						...
						<div class="modal-content">
							<form @submit.prevent="saveCategory">
								<div class="modal-body">
									<h4 class="mb-4 mt-2" style="color: #344767 !important;">Nuevo categoria</h4>
									...
									<div class="form-group">
										<label for="exampleFormControlTextarea1" style="color: #344767 !important;">Descripción</label>
					...
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							<form @submit.prevent="updateCategory">
								<div class="modal-body">
									<h4 class="mb-4 mt-2" style="color: #344767 !important;">Actualizar categoria</h4>
									<div class="form-group">
										<label for="example-text-input" class="form-control-label" style="color: #344767 !important;">Nombre<span class="text-danger"> *</span></label>
										<input v-model="name" class="form-control" type="text" placeholder="Nombre del categoria" :class="{ 'is-invalid': errors.name }">
										<div class="invalid-feedback">{{ errors.name }}</div>
