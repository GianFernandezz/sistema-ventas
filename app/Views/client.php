					...
					<div class="card-header pb-0">
						<div class="d-lg-flex">
							...
							<div class="ms-auto my-auto mt-lg-0 mt-4">								
								<a href="<?= base_url('reports/reportall/downloadExcelClient'); ?>" class="btn bg-gradient-default me-4" data-toggle="tooltip" data-placement="top" title="Reporte Excel">
									<img src="<?= base_url('assets/img/excel.png'); ?>" alt="Download-Excel">
								</a>	
								<a href="<?= base_url('reports/reportall/rptClient'); ?>" class="btn bg-gradient-default" data-toggle="tooltip" data-placement="top" title="Reporte PDF" target="_blank">
									...
									<tr v-for="(item, index) in rows()">
										...
										<td>
											<div class="ms-auto text-lg d-flex px-2">
												<div><a class="btn btn-link px-3 mb-0 bg-gradient-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#modalEdit" @click="readClient(index)"><i class="fas fa-pencil-alt me-2"></i>Edit</a></div>
												<div><a class="btn btn-link px-3 mb-0 bg-gradient-danger btn-sm" @click="deleteClient(item.id)"><i class="fa fa-trash me-2"></i>Delete</a></div>
											</div>
										</td>
						...
						<div class="modal-content">
							<form @submit.prevent="saveClient">
								<div class="modal-body">
									...
									<div class="row">
										<div class="col-md-12">
											<h4 class="mb-2" style="color: #344767 !important;">Nuevo cliente</h4>
											<div class="form-group">
												<label for="example-text-input" class="form-control-label" style="color: #344767 !important;">Nombre Cliente / Empresa<span class="text-danger"> *</span></label>
										...
										<div class="col-md-4">
											<div class="form-group">
												<label style="color: #344767 !important;">T. Documento<span class="text-danger"> *</span></label>
										...
										<div class="col-md-8">
											<div class="form-group">
												<label for="example-text-input" class="form-control-label" style="color: #344767 !important;">N° Documento<span class="text-danger"> *</span></label>
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												<label for="exampleFormControlTextarea1" style="color: #344767 !important;">Direccion<span class="text-danger"> *</span></label>
						...
						<div class="modal-content">
							<form @submit.prevent="updateClient">
								<div class="modal-body">
									...
									<div class="row">
										<div class="col-md-12">
											<h4 class="mb-2" style="color: #344767 !important;">Actualizar cliente</h4>
											<div class="form-group">
												<label for="example-text-input" class="form-control-label" style="color: #344767 !important;">Nombre Cliente / Empresa<span class="text-danger"> *</span></label>
												<input v-model="name" class="form-control" type="text" placeholder="Nombre Cliente / Empresa" :class="{ 'is-invalid': errors.name }">
												<div class="invalid-feedback">{{ errors.name }}</div>
