					...
					<div class="card-header pb-0">
						<div class="d-lg-flex">
							...
							<div class="ms-auto my-auto mt-lg-0 mt-4">								
								<a href="<?= base_url('reportall/downloadExcelUser'); ?>" class="btn bg-gradient-default me-4" data-toggle="tooltip" data-placement="top" title="Reporte Excel">
									<img src="<?= base_url('assets/img/excel.png'); ?>" alt="Download-Excel">
								</a>	
								<a href="<?= base_url('reportall/rptUser'); ?>" class="btn bg-gradient-default" data-toggle="tooltip" data-placement="top" title="Reporte PDF" target="_blank">
