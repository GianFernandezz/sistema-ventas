					...
					<div class="card-header pb-0">
						<div class="d-lg-flex">
							...
							<div class="ms-auto my-auto mt-lg-0 mt-4">								
								<a href="<?= base_url('reports/reportall/downloadExcelUser'); ?>" class="btn bg-gradient-default me-4" data-toggle="tooltip" data-placement="top" title="Reporte Excel">
									<img src="<?= base_url('assets/img/excel.png'); ?>" alt="Download-Excel">
								</a>	
								<a href="<?= base_url('reports/reportall/rptUser'); ?>" class="btn bg-gradient-default" data-toggle="tooltip" data-placement="top" title="Reporte PDF" target="_blank">
							...
							<table class="table align-items-center">
								<thead>
									<tr>
										...
										<!-- <th class="text-center text-uppercase text-xs font-weight-bolder opacity-7">Opciones</th> -->
									...
									<tr v-for="(item, index) in rows()">
										...
										<td>
											<div class="ms-auto text-lg d-flex px-2">
												<div><a class="btn btn-link px-3 mb-0 bg-gradient-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#modalEdit" @click="readUser(index)"><i class="fas fa-pencil-alt me-2"></i>Edit</a></div>
												<div><a class="btn btn-link px-3 mb-0 bg-gradient-danger btn-sm" @click="deleteUser(item.id)"><i class="fa fa-trash me-2"></i>Delete</a></div>
											</div>
										</td>
						...
						<div class="modal-content">
							<form @submit.prevent="saveUser">
								<div class="modal-body">
									...
									<div class="row">
										<div class="col-md-12">
											<h4 class="mb-2" style="color: #344767 !important;">Nuevo usuario</h4>
											<div class="form-group">
												<label for="example-text-input" class="form-control-label" style="color: #344767 !important;">Nombre completo<span class="text-danger"> *</span></label>
											...
											<div class="form-group">
												<label for="example-text-input" class="form-control-label" style="color: #344767 !important;">Nombre de usuario<span class="text-danger"> *</span></label>
										...
										<div class="form-group">
											<label for="example-text-input" class="form-control-label" style="color: #344767 !important;">Email<span class="text-danger"> *</span></label>
											<input v-model="email" class="form-control" type="text" placeholder="Email" :class="{ 'is-invalid': errors.email }">
											<div class="invalid-feedback">{{ errors.email }}</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label for="example-text-input" class="form-control-label" style="color: #344767 !important;">Contraseña<span class="text-danger"> *</span></label>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label for="example-text-input" class="form-control-label" style="color: #344767 !important;">Confirma la contraseña<span class="text-danger"> *</span></label>
						...
						<div class="modal-content">
							<form @submit.prevent="updateUser">
								<div class="modal-body">
									...
									<div class="row">
										<div class="col-md-12">
											<h4 class="mb-2" style="color: #344767 !important;">Actualizar usuario</h4>
											<div class="form-group">
												<label for="example-text-input" class="form-control-label" style="color: #344767 !important;">Nombre completo<span class="text-danger"> *</span></label>
												<input v-model="fullname" class="form-control" type="text" placeholder="Nombre completo" :class="{ 'is-invalid': errors.fullname }">
												<div class="invalid-feedback">{{ errors.fullname }}</div>
